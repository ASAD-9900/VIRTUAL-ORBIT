      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:pb-25">
            <h2 className="text-3xl sm:text-4xl font-montserrat lg:text-5xl text-gray-900 leading-tight">How To Choose 
              <span className='bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent'>Ecommerce SEO Agency </span>
            ...
            <div className="space-y-6 text-gray-900 leading-relaxed">
              ...
              <p className="text-lg">
                <span className="font-bold text-blue-600">Zero-Click Search</span> is commonplace, 
