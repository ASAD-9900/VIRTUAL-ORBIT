      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:pb-25">
            <h2 className="text-3xl sm:text-4xl font-montserrat lg:text-5xl text-white leading-tight">
              <span className='bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent'>Ecommerce SEO Services </span>
