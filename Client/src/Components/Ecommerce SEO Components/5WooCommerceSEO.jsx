          ...
          <div className="w-full lg:w-2/3 space-y-4 sm:space-y-6">
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center lg:text-start font-montserrat text-gray-700 mb-3 sm:mb-4 lg:mb-5">
                Ecommerce SEO For <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent font-['Playfair_Display',serif] italic">Woo Commerce Store?</span> 
              </h2>
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-none">
              <img 
                ...
                className="w-300 h-150 object-contain"
              />
              {/* Floating Elements */}
              <div className="absolute inset-0">
                ...
                <motion.div
                  ...
                  animate="animate"
                  className="absolute -top-2 right-1 sm:top-0 sm:right-2 lg:top-10 lg:-right-32"
                >
                  <img src={Rocket} alt="SEO Rank" className="w-28 h-28 sm:w-28 sm:h-28 lg:w-32 lg:h-32 object-contain" />
                </motion.div>
                {/* Gemini */}
                <motion.div
                  custom={2}
