...
const DigitalVsTraditionalMarketing = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 pb-30 ">
        <div className=" mb-5 pt-8 sm:pt-0">
            <h3 className="text-3xl sm:text-3xl text-center lg:text-5xl font-montserrat text-white leading-tight">Should You Hire An
              <span className='bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent'> Ecommerce SEO Agency</span> Or DIY?
            </h3>
