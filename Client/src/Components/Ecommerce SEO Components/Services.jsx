...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Our Amazon SEO agency writes unique product descriptions, optimized titles and content that encourages shoppers to buy. We also work with your existing creative assets to create a dynamic image set designed to capture interest and inform and persuade consumers to buy. For Amazon Brand Registered sellers, our team develops compelling A+ Content designed to share your brand story, unique product details and comparison charts that help shoppers make the best purchase decisions. For Brand Registered sellers with a variety of products, we also develop a custom Amazon Brand Store that allows shoppers to browse your full catalog."
    },
    {
      number: '06',
      title: 'Amazon Review Strategies',
      description: "Ratings and reviews have a big impact on Amazon SEO and in the minds of Amazon shoppers. That's why Thrive recommends taking a proactive approach to Amazon ratings and reviews. Our Amazon strategists set up automated rating and review requests that adhere to Amazon's strict policies. These automated requests will be branded, personalized and timed to the seller's specifications for optimal review collection. This service also includes review notifications that enable sellers to promptly address any poor customer experiences, increasing the likelihood of getting negative reviews removed or amended."
    }
  ];
