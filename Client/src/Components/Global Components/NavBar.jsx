...
const socialMedia = [
  { name: 'Profile O', description: 'Create memorable brand identities', href: '#', icon: CameraIcon },
...
                  {/* SEO Column */}
                  <div>
                    <a href='/seo-services'><h4 className="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-200 pb-2 hover:text-blue-700">Search Engine Optimization</h4></a>
...
          </Popover>
          
          <a href="#" className="text-base font-semibold text-gray-800 hover:text-[#4f39f6] transition-colors duration-200">
            Pricing
          </a>
          <a href="#" className="text-base font-semibold text-gray-800 hover:text-[#4f39f6] transition-colors duration-200">
            Blog
...
            About Us
          </a>
          <a href="/Contact-Us" className="text-base font-semibold text-gray-800 hover:text-[#4f39f6] transition-colors duration-200">
            Contact Us
          </a>
        </PopoverGroup>
