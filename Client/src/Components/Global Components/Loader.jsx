...
const nextColor = color === "rgb(59,130,246)" ? "white" : "rgb(59,130,246)";
...
const Trippy = ({ rotate }) => {
  return (
    <motion.div className="absolute inset-0 overflow-hidden bg-gray-300">
      {generateSections(0, "rgb(59,130,246)", rotate)}
    </motion.div>
  );
};
