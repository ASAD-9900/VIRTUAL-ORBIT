...
//     <div>                                             
//       <section
//         className={`lg:-mt-30 pt-8 lg:pt bg-gradient-to-b from-[#01091c] via-[#0a244d] to-[#0f3064] bg-center bg-cover ${
//           !imageUrl ? 'pb-7 sm:pb-8' : '' 
//         }`}
//       >  
//         <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center lg:pt-30">
//           <div
...
const HomeHero = ({ 
  ...
  return (
    <div>
      <section
        className={`lg:rounded-4xl lg:mx-10 relative overflow-hidden lg:-mt-27 pt-8 bg-gradient-to-b from-[#01091c] via-[#0a244d] to-[#0f3064] bg-center bg-cover ${!imageUrl ? 'pb-7 sm:pb-8' : ''}`}
      >
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            <div
              className="
                ...
                xl:w-[700px] xl:h-[700px] xl:top-[55%] xl:right-[33%]
                -translate-y-1/2
              "
            >
