...
import BannerGuy from "../../assets/BannerGuy.png"
...
const Banner = () => {
  return (
    ...
    >
      ...
      <div className="hidden sm:block absolute left-4 sm:left-8 lg:left-60 -top-8 sm:-top-12 lg:-top-15 h-[140px] sm:h-[180px] lg:h-[220px] w-auto z-30">
        <img 
          src={BannerGuy} 
      ...
      <div className="sm:hidden relative z-10 h-full flex flex-col items-center justify-center gap-3 px-4">
        ...
        {/* Call Section - Below text on mobile */}
        <a 
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="text-center lg:text-center lg:mt-14 max-w-2xl">
            <h2 className="text-white text-base md:text-lg lg:text-2xl font-bold leading-tight">
              Need SEO Service for growing your<br /> 
              Business? Just Call Us.
            </h2>
          </div>
        </div>

        {/* Call Section - Right side on desktop */}
        <a 
          href="tel:+919641861932" 
      ...
      {/* Hand Image - Visible on all screens */}
      <div className="absolute right-5 sm:right-4 lg:right-8 -bottom-1 w-14 h-14 sm:w-20 sm:h-20 lg:w-28 lg:h-28 z-20">
        <img 
          src={Hand} 
          alt="Hand pointing" 
