...
const Importance = () => {
  return (
    <section className="max-w-6xl bg-gray-50 mx-auto px-4 py-12">
      {/* Header Section */}
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 relative overflow-hidden">
        ...
        <p className="text-gray-700 text-base leading-relaxed relative z-10">
          ...
          <a href="/Contact-Us" className="text-blue-600 underline font-medium hover:text-blue-700 transition-colors">
            Reach out
          </a>{' '}
