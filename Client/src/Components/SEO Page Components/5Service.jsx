  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex flex-col h-auto md:h-[500px] w-full max-w-6xl rounded-[25px] p-6 md:p-8  origin-top"
      >


        <div className="flex flex-col md:flex-row h-full gap-6 md:gap-8 lg:gap-12">
          {/* Description */}
          <div className="w-full md:w-3/6 relative md:top-[10%]">
          {/* Title */}
            <h2 className="text-start text-2xl md:text-3xl lg:text-4xl font-base m-0 mb-6 md:mb-8">
              {project.title}
            </h2>
          ...
          {/* Image */}
          <div className="relative w-full md:w-3/6 h-64 md:h-full rounded-[20px] md:rounded-[25px] overflow-hidden">
            <motion.div 
