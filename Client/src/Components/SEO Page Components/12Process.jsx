  ...
  return (
    <section className="py-20 bg-[#f7fbff] relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        <div className=" mb-5">
          <h3 className="text-3xl font-montserrat md:text-5xl text-center font- text-gray-800 mb-6">
            Virtual Orbit's Approach To <span className="font-['Playfair_Display',serif] italic bg-gradient-to-r from-pink-500 via-orange-400 to-pink-400 bg-clip-text text-transparent">SEO Services</span>
          </h3>
