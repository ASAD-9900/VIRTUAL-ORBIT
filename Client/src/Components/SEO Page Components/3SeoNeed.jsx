...
const WhatsSEO = () => {
  return (
      ...
      <section 
        className="max-w-full bg-gradient-to-b from-[#0f3064] via-[#2563eb] to-[#0f3064]">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12">
        ...
        <div className="lg:w-2/3 space-y-6">
          <div>
            <h2 className="text-4xl md:text-5xl lg:text-5xl text-center sm:text-start font-montserrat md:text-5xl  text-gray-200 mb-5">
              Why Your Business Need <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent font-['Playfair_Display',serif] italic">Search Engine Optimization</span> Service?
            </h2>
            <p className="text-lg text-center sm:text-start text-blue-200 font-medium">
          ...
          <p className="text-lg lg:text-xl text-white leading-relaxed">
            ...
            marketing to{' '}
            <a href="#" className="text-blue-200 underline hover:text-blue-800 font-medium">
              email campaigns and pay-per-click advertising
            </a>
            . The goal is to reach your target audience where they're already spending their.
          </p>
