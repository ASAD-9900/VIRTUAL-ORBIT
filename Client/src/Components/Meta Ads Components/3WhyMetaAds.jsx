...
import Heading from "../Global Components/HeadingAnimation"
  ...
  return (
    ...
    <section className="max-w-full bg-gradient-to-b from-[#0f3064] via-[#2563eb] to-[#0f3064]" >
      <div className="max-w-7xl mx-auto px-6 py-6  space-y-16">
        <div className='mb-6'>
            <h2 className="text-4xl  md:text-5xl lg:text-5xl text-center  text-gray-200 mt-8 mb-15">
              Why Your Business Need{' '}
              <span className="bg-gradient-to-r  from-orange-400 via-pink-400  to-purple-500 bg-clip-text font-['Playfair_Display',serif] italic text-transparent">
                Meta Ads Management?
              </span>
            </h2>
