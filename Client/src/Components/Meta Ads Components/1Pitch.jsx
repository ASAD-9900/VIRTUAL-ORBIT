...
const [activeTab, setActiveTab] = useState('visibility');
  ...
  return (
    <div>
        <div className="lg:mx- py-8 px-6 bg-white">
              <div className="max-w-7xl mx-auto">
                {/* Header Section */}
                <div className="text-center mb-16">
                  <h1 className="text-4xl font-montserrat md:text-5xl lg:text-6xl  text-gray-800 mb-4">
                    AI-Driven Meta Ads Agency for{' '}
                ...
                {/* Content Section */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start lg:pb-4">
                  {/* Left Column  */}
                  <div className="space-y-6">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      ...
                      <span className="text-blue-600 font-semibold underline decoration-green-200 decoration-2">
