         ...
         <div className='max-w-7xl mx-auto px-6  py-6'>
            <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div>
                    ...
                    What's <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent font-['Playfair_Display',serif] italic"> Google Ads Management Services?</span>
                    </h2>
