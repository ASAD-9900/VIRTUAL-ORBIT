...
const Result
 = () => {
  return (
      ...
      > 
      <div className='max-w-6xl mx-auto px-4 py-4 lg:pb-25'>
            ...
            <div className="space-y-6">
              <div className="space-y-2 text-center">
                <h2 className="text-3xl sm:text-3xl lg:text-5xl font-montserrat text-white leading-tight">
                  What Factors Affect <span className='bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent'>Google Ads Cost?</span> 
                </h2>
