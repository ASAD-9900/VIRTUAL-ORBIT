...
const WhatsSEO = () => {
  ...
  return (
    <section 
      ref={ref}
      className="max-w-full bg-[#0f3064]" 
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-16 pb- sm:pb-12 lg:pb-14'>
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-2/3 space-y-4 sm:space-y-6">
            ...
            <p className="text-lg lg:text-xl text-gray-200 leading-relaxed text-center lg:text-left">
          ...
          <div className="w-full h-auto lg:w-1/2 flex justify-center align-center relative">
