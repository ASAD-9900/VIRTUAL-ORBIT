      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:pb-25">
            <h2 className="text-3xl sm:text-4xl text-center sm:text-start font-montserrat lg:text-5xl text-gray-900 leading-tight">
              Why Should You Invest In <span className="font-['Playfair_Display',serif] italic bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent"> PPC Marketing Services?</span>
            </h2>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <p className="text-lg lg:text-xl">
                ...
                <div className=" mt-10 flex justify-center sm:justify-start lg:hidden pb-4">
