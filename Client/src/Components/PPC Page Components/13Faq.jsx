      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12'>
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-montserrat lg:text-5xl  text-white mb-2">
            FAQ About <span className="font-['Playfair_Display',serif] italic bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent">PPC Marketing Services</span>
          </h2>
