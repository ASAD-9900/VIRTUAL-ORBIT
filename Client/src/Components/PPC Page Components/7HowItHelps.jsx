      ...
      <div className='max-w-7xl mx-auto px-6 py-12'>
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-montserrat md:text-5xl text-white mb-3">
            How <span className="font-['Playfair_Display',serif] italic bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent"> PPC Marketing Services</span> Help Your Business?
          </h2>
