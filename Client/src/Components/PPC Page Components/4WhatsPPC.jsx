...
function Filler() {
  return (
      <div className="py-2 px-4 sm:px-6 lg:px-8 mt-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center"> 
          {/* Content */}
          <div className="space-y-6 lg:pb-25">
            <h2 className="text-4xl font-sans sm:text-3xl lg:text-5xl text-center sm:text-start font-montserrat text-gray-700 leading-tight">What's
              <span className="font-['Playfair_Display',serif] italic bg-gradient-to-r from-pink-500 via-orange-400 to-pink-400 bg-clip-text text-transparent"> PPC Marketing Service?
              </span> 
            </h2>
            
            <h3 className="text-lg sm:text-xl font-semibold text-center sm:text-start text-gray-600 leading-relaxed">
            ...
            <div className="space-y-6 text-gray-800 leading-relaxed">
              ...
              <p className="text-lg lg:text-xl">
                ...
                <div className=" mt-10 flex justify-center sm:hidden pb-4">
