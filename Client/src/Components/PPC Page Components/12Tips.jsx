      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
        ...
        <div className="md:text-center md:mb-12">
          <h2 className="text-3xl font-montserrat md:text-5xl text-start sm:text-center text-gray-800 mb-2">
            Some Tips Regarding <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text text-transparent font-['Playfair_Display',serif] italic">PPC Marketing Services</span>  
          </h2>
