    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        <h3 className="text-3xl md:text-5xl font-montserrat text-gray-900 mb-2">
          How To Choose the <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text  text-transparent font-['Playfair_Display',serif] italic">
            Best PPC Marketing Company? </span> 
        </h3>
