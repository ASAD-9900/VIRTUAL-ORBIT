  ...
  >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
        ...
        <div className="md:text-center md:mb-12">
          <h2 className="text-3xl font-montserrat md:text-5xl text-center sm:text-start text-gray-800 mb-2">
          ...
          <p className="text-gray-400 text-lg text-center sm:text-start font-semibold">
