      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <h4 className="text-3xl lg:text-4xl text-center sm:text-start font-montserrat text-gray-800 leading-tight">
             Why Choose Us For<br />
              <span className="bg-gradient-to-r from-orange-400 via-pink-400 to-purple-500 bg-clip-text  text-transparent">Digital Marketing Services?</span>
            </h4>
